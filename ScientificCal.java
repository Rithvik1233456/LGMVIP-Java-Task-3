...
public class ScientificCal {
    ...
    private void initialize() {
        fre = new JFrame();
        fre.setForeground(Color.BLACK);
        fre.getContentPane().setForeground(Color.GRAY);
        fre.setBounds(600, 100, 360, 600);
        ...
        lblNewLabel.setBounds(42, 8, 300, 27);
        ...
        bt2.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        bt5.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        bt8.setFont(new Font("Arial", Font.BOLD, 23));
        bt8.setBounds(139, 295, 64, 50);
        fre.getContentPane().add(bt8);
        JButton btC = new JButton("AC");
        btC.setFont(new Font("Arial", Font.BOLD, 19));
        ...
        btLn.setFont(new Font("Arial", Font.BOLD, 13));
        ...
        bt0.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btSin.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btDot.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btEqual.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btXrx.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btLog.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btCe.setFont(new Font("Arial", Font.BOLD, 19));
        ...
        bt7.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        bt4.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        btX.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btEx.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btSqrt.setFont(new Font("Arial", Font.BOLD, 17));
        ...
        btCos.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btCos_1.setFont(new Font("Arial", Font.BOLD, 13));
        btCos_1.setBounds(202, 191, 64, 50);
        fre.getContentPane().add(btCos_1);
        JButton btBackSpace = new JButton("BACK");
        ...
        btBackSpace.setFont(new Font("Arial", Font.BOLD, 10));
        ...
        bt9.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        bt6.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        bt3.setFont(new Font("Arial", Font.BOLD, 23));
        ...
        btTan.setFont(new Font("Arial", Font.BOLD, 12));
        ...
        btTan_1.setFont(new Font("Arial", Font.BOLD, 11));
        ...
        btPlus.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btSub.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btMul.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btDivide.setFont(new Font("Arial", Font.BOLD, 21));
        ...
        btP_1.setFont(new Font("Arial", Font.BOLD, 16));
